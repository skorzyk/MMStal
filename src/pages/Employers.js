        ...
        <div className="history--container" data-aos={"fade-up"}>
          ...
          <div className="history__column--container">
            <p className="history__desc--main">
              ...
              wielkości garażu. Ciężką pracą i wytrwałością pozyskaliśmy
              kolejnych klientów, rozwinęliśmy swój warsztat oraz zdobyliśmy
        ...
        <div className="employee--container" data-aos={"fade-right"}>
          ...
          <div className="employee__desc--container">
            ...
            <p className="employee__desc">
              ...
              wytrwałości ukończył studia inżynierskie na Politechnice
              Krakowskiej i rozpoczął własną działalność. Marcin osobiście
              zajmuje się obsługą klientów i dbaniem o najwyższe standardy
              wykonywanych zleceń. Jego praca rozpoczyna się od bezpośredniego
              kontaktu z zainteresowanymi osobami poprzez wycenę, pomiar oraz
              wykonanie szczegółowych projektów danego przedmiotu. Jego wiedza i
              doświadczenie przekładają się na całokształt pracy wykonywanej w
              firmie, ponieważ bierze czynny udział we wszystkich etapach
              wykonywania oraz montażu projektów.
            </p>
          </div>
        </div>
        <div className="employee--container" data-aos={"fade-right"}>
          ...
          <div className="employee__desc--container">
            ...
            <p className="employee__desc">
              Monter konstrukcji stalowych, spawacz. Swoje doświadczenie
              zdobywał w Polsce jak i poza granicami naszego kraju, biorąc
              udział w budowaniu hal o powierzchni od 50 do 100 metrów
              kwadratowych, poczynając od spawania, nadzór, aż po mistrza w
              budownictwie konstrukcji stalowych. Doświadczenie jakie posiada
              bezpośrednio przekłada się na jakość, jak i wytrzymałość
              konstrukcji jakie dla Państwa wykonujemy.
            </p>
          </div>
        </div>
        <div className="employee--container" data-aos={"fade-right"}>
          ...
          <div className="employee__desc--container">
            ...
            <p className="employee__desc">
              ...
              wykonywał konstrukcje stalowe między innymi wieże
              telekomunikacyjne, słupy wysokiego napięcia, elementy stałe hal.
              Konstrukcje które wykonywał sięgały do 60-70 metrów, a grubość
              materiału wynosiła od 2mm do 40mm. Warto nadmienić, że większość
              wykonywanych prac była poddawana badaniom RTG co świadczy o
              dokładności wykonywanych łączeń spawalniczych.
            </p>
          </div>
        </div>
        <div className="employee--container" data-aos={"fade-right"}>
          ...
          <div className="employee__desc--container">
            ...
            <p className="employee__desc">
              Monter konstrukcji stalowych oraz pomocnik spawacza. Swoją
              przygodę z metaloplastyka rozpoczął w trybie pracy sezonowej, jako
              pomocnik spawacza oraz pomocnik przy montażu konstrukcji. W miarę
              upływu czasu i nabieranego doświadczenia praca dorywcza stała się
              jego pomysłem na życie. W naszej firmie zajmuje się obróbką
              materiału poczynając od przygotowania i pocięcia materiału pod
              wymiar do finalnego oczyszczenia, szlifowania i wykończenia po
              montaż wykonanych konstrukcji.
            </p>
          </div>
        </div>
      </section>
