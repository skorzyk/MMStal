...
import exampleImg from '../../images/wlasne/balustrady2_wlasne.jpg';
...
const OfferRailingsInside = () => {
    ...
    return (
        ...
        <p className='offer-railings__description'>
          ...
          balustrad oraz poręczy ściennych oferuje dla swoich klientów
najwyższej
          jakość usługi.
        </p>
        <p className='offer-railings__description'>
              ...
              <div className='offer-railings__pattern-description'>
                <div className='offer-railings__pattern-description-wrapper'>
                  ...
                  <p className='offer-railings__pattern-description-info'>
                    ...
                    zamknięty 40x40x2 z wypełnieniem pionowym
15x15x1,5 w odstępie
